            ...
            <nav>
                <ul class="navbar-list" data-visible="false">
                    <li class="navbar-item">
                        <a href="accueil" class="navbar-item-a <?php echoIfActive("index.php")?>">Accueil</a>
                    </li>
                    <li class="navbar-item">
                        <a href="/wiki" class="navbar-item-a <?php echoIfActive("wiki")?>">Wiki</a>
                    </li>
                    <li class="navbar-item">
                        <a href="votes" class="navbar-item-a <?php echoIfActive("votes.php")?>">Votes</a>
                    </li>
                    <li class="navbar-item">
                        <a href="events" class="navbar-item-a <?php echoIfActive("events.php")?>">Events</a>
                    </li>
                    <li class="navbar-item">
                        <a href="wiki/regles" class="navbar-item-a <?php echoIfActive("cgu-cgv.php")?>">Regles</a>
                    </li>
                    <li class="navbar-item">
                        <a href="equipe" class="navbar-item-a <?php echoIfActive("staff.php")?>">Equipe</a>
                    </li>
